...
## Collect statistics on the use of open source
 TOAST UI Placeholder applies Google Analytics (GA) to collect statistics on the use of open source, in order to identify how widely TOAST UI Placeholder is used throughout the world.
