...
describe('util.js', function() {
    describe('bindEvent', function() {
        it('should bind event handler to target element', function() {
        ...
        it('should set callback function as a prop to target element', function() {
            var input = $('<input>')[0];
    ...
    describe('unbindEvent', function() {
        it('should unbind event handler from target element', function() {
            var callback = jasmine.createSpy('callback');
            var input = $('<input>')[0];
